#
#  Be sure to run `pod spec lint Objective-CSS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Objective-CSS"
  s.version      = "0.0.1"
  s.summary      = "A short description of Objective-CSS."
  ...
  s.homepage     = "http://EXAMPLE/Objective-CSS"
  ...
  s.osx.deployment_target = '10.7.0'
  ...
  s.source       = { :git => "https://github.com/zakdances/Objective-CSS.git", :tag => "v#{s.version}" }
