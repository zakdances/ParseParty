...
//                                 @"selector": @".myClass1" ,
//                                 @"block" : @[].mutableCopy};
    PPRuleSet *rule1 = [PPRuleSet ruleWithSelector:@".myClass1" andBlockContent:nil];
    PPRuleSet *rule2 = [PPRuleSet ruleWithSelector:@"> header" andBlockContent:nil];
    PPRuleSet *rule3 = [PPRuleSet ruleWithSelector:@"> .content" andBlockContent:nil];
    PPRuleSet *rule4 = [PPRuleSet ruleWithSelector:@".myClass2" andBlockContent:nil];
