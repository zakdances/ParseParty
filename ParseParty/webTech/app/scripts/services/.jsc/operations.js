...
(function() {
  ...
  angular.module('ParsePartyApp.services').factory('CMOperation', function($q, jsBridge) {
    var CMOperation;
    CMOperation = (function() {
      function CMOperation(_cm, type) {
        ...
        this.p.then(function() {}, function(error) {
          jsBridge.then(function(jsBridge) {
    ...
    return CMOperation;
  }).factory('CMRangeOp', function(CMOperation, $q, jsBridge) {
    var CMRangeOp;
    ...
    return CMRangeOp;
  }).factory('CMParseRangeOp', function(CMOperation, jsBridge) {
    var CMParseRangeOp;
    ...
    return CMParseRangeOp;
  }).factory('CMSelectedRangesOp', function(CMOperation, $q, jsBridge) {
    ...
    return CMSelectedRangesOp;
  }).factory('CMModeOp', function(CMOperation, jsBridge) {
    var CMModeOp_;
    ...
    return CMModeOp_;
  }).factory('CMTokenizeOp', function(CMOperation, jsBridge) {
    var CMTokenizeOp;
    ...
    return CMTokenizeOp;
  }).factory('CMDocLengthOp', function(CMOperation, jsBridge) {
    var CMDocLengthOp;
